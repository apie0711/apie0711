...
- 🌐 **Java / Python**으로 웹 백엔드와 제어 프로그램을 만들어요.
- 🔧 **Linux, Arduino, Jetson Nano**로 소프트웨어를 실제 하드웨어에 연결해요.
- 📡 요즘은 **mmWave 레이더 + 비전 융합**, **OpenSCAD 3D 프린팅 설계**에 빠져 있습니다.
...
<h4><a href="https://github.com/apie0711">Smart Road Saver</a></h4>

44th 졸업전시회(EXPO) 출품작. **mmWave 레이더(IWR6843AOPEVM)** + **YOLO11n** 비전 융합으로 도로 위험 요소를 감지하고, Jetson Nano에서 TensorRT로 추론한 결과를 PostGIS/Socket.IO 기반 웹·모바일 관제 화면으로 실시간 전달합니다.

<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/> <img src="https://img.shields.io/badge/YOLO11n-000000?style=flat-square&logo=yolo&logoColor=white"/> <img src="https://img.shields.io/badge/TensorRT-76B900?style=flat-square&logo=nvidia&logoColor=white"/> <img src="https://img.shields.io/badge/PostGIS-336791?style=flat-square&logo=postgresql&logoColor=white"/>

</td>
<td width="50%" valign="top">
<h3>🖨️ Hardware</h3>
<h4>3D-Printable 4WD Robot Chassis</h4>

졸업작품에 쓰인 레이더·Jetson Nano를 그대로 재활용하는 4WD 로봇 섀시를 **OpenSCAD**로 설계 중. 무(無)서포트 출력, Osmo Pocket 마운트, 레이더 서랍형 마운트까지 고려한 구조예요.

<img src="https://img.shields.io/badge/OpenSCAD-F9D72C?style=flat-square&logo=openscad&logoColor=black"/> <img src="https://img.shields.io/badge/3D%20Printing-FF6F00?style=flat-square"/> <img src="https://img.shields.io/badge/Jetson%20Nano-76B900?style=flat-square&logo=nvidia&logoColor=white"/>
...
<td width="50%" valign="top">
<h3>⚙️ Backend</h3>
<h4><a href="https://github.com/apie0711/temporence_backend">Java Backend</a></h4>

Java · Spring Boot 기반 백엔드 저장소. 인증, 사용자, 친구, 캐릭터 관련 API 코드가 담겨 있어요.

<img src="https://img.shields.io/badge/Java-007396?style=flat-square&logo=openjdk&logoColor=white"/> <img src="https://img.shields.io/badge/Spring%20Boot-6DB33F?style=flat-square&logo=springboot&logoColor=white"/> <img src="https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white"/>

</td>
<td width="50%" valign="top">
<h3>🤖 Embedded</h3>
<h4>Jetson Nano & Arduino RC Car</h4>

로봇과 RC카를 만들며 실험 중. 리눅스 환경 구성부터 센서, 모터, 블루투스 제어까지 직접 다뤄보고 있어요.

<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/> <img src="https://img.shields.io/badge/Arduino-00979D?style=flat-square&logo=arduino&logoColor=white"/> <img src="https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black"/>
...
PC 하드웨어를 주제로 만든 웹 프로젝트. 상품 카테고리, 검색, 배너 슬라이더와 로그인 화면을 구현했어요.
...
주식 모의투자 앱을 준비하고 있어요. 앱 아이디어와 브랜드를 구체화하고 있습니다.

<img src="https://img.shields.io/badge/In%20Progress-FFA500?style=flat-square"/> <img src="https://img.shields.io/badge/Paper%20Trading-2c5364?style=flat-square"/>
...
<img src="https://skillicons.dev/icons?i=c,cpp,python,java,js,html,css,spring,mysql,linux,ubuntu,arduino,opencv,git,github,vscode&theme=dark" />
...
| **Web & Backend** | `HTML` `CSS` `JSP` `Spring Boot` `MySQL` |
| **AI / Vision** | `YOLO11n` `TensorRT` `OpenCV` |
| **Systems & Embedded** | `Linux` `Ubuntu` `Arduino` `Jetson Nano` `mmWave Radar` |
...
[![apie0711의 Solved.ac 프로필 — 최신 티어와 문제 풀이 기록](https://mazassumnida.wtf/api/v2/generate_badge?boj=apie0711)](https://solved.ac/apie0711)

[Baekjoon 기록 보기 ↗](https://www.acmicpc.net/user/apie0711)
